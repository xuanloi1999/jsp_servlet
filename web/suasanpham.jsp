...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="XuLySuaSanPham">
                    <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Ma</label>
                    <input type="text" value="${sp.ma}" class="form-control" id="exampleInputEmail1" readonly name="ma" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Ten</label>
                    <input type="text" value="${sp.ten}"  class="form-control" name="ten" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Gia</label>
                    <input type="text" value="${sp.gia}" class="form-control" name="gia" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Hinh</label>
                    <input type="text" value="${sp.gia}" class="form-control" id="exampleInputEmail1" name="hinh" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Chi tiet</label>
                    <input type="text" value="${sp.chiTiet}" class="form-control" id="exampleInputEmail1" name="chitiet" aria-describedby="emailHelp">
