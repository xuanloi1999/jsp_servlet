...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="XuLySuaDanhMucHoanThanh">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Ma</label>
                    <input type="text" value="${dm.ma}"  class="form-control" id="exampleInputEmail1" readonly name="madanhmuc" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Ten</label>
                    <input type="text"   class="form-control" value="${dm.ten}" name="ten" id="exampleInputPassword1" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Ghi chu</label>
                    <input type="text"   class="form-control" value=" ${dm.ghiChu}" name="ghichu" id="exampleInputPassword1" required>
                </div>
