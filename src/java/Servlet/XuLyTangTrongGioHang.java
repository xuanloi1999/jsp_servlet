 ...
 * @author xuanl
 */
@WebServlet(name = "XuLyTangTrongGioHang", urlPatterns = {"/XuLyTangTrongGioHang"})
public class XuLyTangTrongGioHang extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(XuLyTangTrongGioHang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
