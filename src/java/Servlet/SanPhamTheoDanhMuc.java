 ...
 * @author xuanl
 */
@WebServlet(name = "SanPhamTheoDanhMuc", urlPatterns = {"/SanPhamTheoDanhMuc"})
public class SanPhamTheoDanhMuc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SanPham> dssp =  spd.getTatCaSanPhamTheoDanhMuc(ma);
        ...
        request.getRequestDispatcher("danhsachsanphamtheodanhmuc.jsp").forward(request, response);
    }
