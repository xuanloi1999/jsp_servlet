 ...
 * @author xuanl
 */
@WebServlet(name = "XuLyGioHang", urlPatterns = {"/XuLyGioHang"})
public class XuLyGioHang extends HttpServlet {
    QuanLySanPhamEntity qlsp;

    public XuLyGioHang() {
        qlsp = new QuanLySanPhamEntity();
    }
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(XuLyGioHang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
