 ...
 * @author xuanl
 */
@WebServlet(name = "XuLyTacVuTrongGioHang", urlPatterns = {"/XuLyTacVuTrongGioHang"})
public class XuLyTacVuTrongGioHang extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(XuLyTacVuTrongGioHang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
